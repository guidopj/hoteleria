	...
	public class ClienteTest extends TestCase{
		...
		public void setUp(){
			...
			c = new Cliente("Alguien", "Gomez", 32543234, mockedPortal);
			 d1 = new SimpleDateFormat("2000,10,10");
			 d2 = new SimpleDateFormat("2000,10,15");
		}
		
		public void testReservasRealizadasEnEEUU(){
			Reserva r1 = new Reserva(mockedHabitacion,c,d1,d2,"EEUU");
			Reserva r2= new Reserva(mockedHabitacion,c,d1,d2,"EEUU");
			Reserva r3 = new Reserva(mockedHabitacion,c,d1,d2,"Hong Kong");
			...
			c.obtenerReservasRealizadasEn("EEUU");
		}
	}
}
